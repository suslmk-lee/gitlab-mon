...
export namespace main {
	...
	export class KCSessionStat {
	    product: string;
	    client_id: string;
	    active: number;
	
	    static createFrom(source: any = {}) {
	        return new KCSessionStat(source);
	    }
	...
	export class KCLoginResult {
	    ...
	    static createFrom(source: any = {}) {
	        return new KCLoginResult(source);
	    }
	...
	export class KosmosNameCount {
	    name: string;
	    count: number;
	
	    static createFrom(source: any = {}) {
	        return new KosmosNameCount(source);
	    }
	...
	export class KosmosUsageResult {
	    ...
	    static createFrom(source: any = {}) {
	        return new KosmosUsageResult(source);
	    }
